...
Velor automations currently store all variables in plaintext TOML files. When using API keys (e.g., ZAI_API_KEY for glm/glm4),  
users must either:                                                                                                              
...
pub async fn check_gitignore(git_root: &Path) -> Result<()> {                                                                   
    ...
    if gitignore.exists() {                                                                                                     
        ...
        eprintln!("⚠   Warning: No .gitignore found");                                                                          
        warned = true;                                                                                                          
    }                                                                                                                           
    ...
    if !warned {                                                                                                                
        eprintln!("⚠   Warning: Vault file '{}' may not be excluded from git", velor_entry);                                    
